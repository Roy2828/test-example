...
import com.example.myapplication.uploadnew.UploadInit
import com.example.myapplication.uploadnew.UploadSharding
import com.example.myapplication.uploadnew.UploadTask
...
class UploadActivity :AppCompatActivity() , CoroutineScope by MainScope() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        UploadInit.getInstance().init(uploadSharding)
