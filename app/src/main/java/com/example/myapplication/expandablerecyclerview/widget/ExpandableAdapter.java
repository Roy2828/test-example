 ...
 *
 */
package com.example.myapplication.expandablerecyclerview.widget;
...
import com.example.myapplication.expandablerecyclerview.util.Packager;
import com.example.myapplication.expandablerecyclerview.util.Preconditions;
        ...
        extends RecyclerView.Adapter<BaseViewHolder>
{
    ...
    @IntDef({ExpandCollapseMode.MODE_DEFAULT, ExpandCollapseMode.MODE_SINGLE_EXPAND, ExpandCollapseMode.MODE_SINGLE_COLLAPSE})
    @interface Mode {
    }
    ...
    public int getExpandCollapseMode() {
        return mExpandCollapseMode == null ? ExpandCollapseMode.MODE_DEFAULT : mExpandCollapseMode.mode;
    }
